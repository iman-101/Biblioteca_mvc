...
CREATE TABLE ejemplares (
  id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  idlibro INT(11) NOT NULL,
  anyo INT(11) NOT NULL COMMENT 'Año de edición',
  edicion INT(11) NOT NULL DEFAULT 1 COMMENT 'Número de edición',
...
(17, 'Cómic','Tebeos, cómics con ilustraciones');

-- inserción de registros en la tabla "libros"
INSERT INTO libros(id, isbn, titulo, editorial, idioma, autor, ediciones, edadrecomendada) VALUES
...
(15, '015-7-51619-909-4', 'Games on Internet', 'WWW Fun', 'Inglés', 'Rod Flanders', 1, 18),
...
(18, '017-1-57519-209-1', 'Los Pilares de la tierra', 'Planeta', 'Castellano', 'Ken Follet', 15, 18),
(19, '007-2-57419-138-2', 'Palmeras en la nieve', 'Altaya', 'Castellano', 'Luz Gabás', 10, 14),
(20, '013-7-57539-126-5', 'A sangre fría', 'Planeta', 'Castellano', 'Truman Capote', 15, 18),
(21, '941-6-98574-124-5', 'Fundamentos de la ingeniería de control', 'Ed.Areces', 'Castellano', 'Jose Solís', 5, 0),
(22, '854-1-36528-412-1', 'Engineering for Dummies', 'Books for Dummies', 'Inglés', 'Michael Most', 3, 0),
(23, '321-3-45652-214-2', 'Programación en C#', 'McGraw Hill', 'Castellano', 'Mikel Olarrustegui', 9, 0),
(24, '342-3-44352-114-3', 'Programación en Java', 'McGraw Hill', 'Castellano', 'Mikel Olarrustegui', 4, 0),
(25, '123-6-18475-214-3', 'Cómo superar el miedo', 'Home Alone', 'Castellano', 'Jason Friday', 1, 14),
(26, '151-1-52434-652-8', '1984', 'Planeta', 'Catalán', 'George Orwell', 10, 14),
(27, '474-3-56434-652-4', 'JARRIPOTER: El mago cabezón', 'Evargas', 'Castellano', 'Enrique Vargas', 1, 12),
(28, '251-6-58439-652-3', 'Mortadelo y Filemón Barcelona 92', 'Bruguera', 'Castellano', 'Francisco Ibáñez', 10, 0),
(29, '253-1-52536-652-2', 'Los Silencios de Hugo', 'Amazon', 'Castellano', 'Inma Chacón', 1, 12),
(30, '456-8-58434-952-1', 'Symfony 6 and MariaDB', 'PHP Developers', 'Inglés', 'Robert Sallent', 2, 0);
...
(17,28),(14,29),(1,30),(3,30),(5,30);

-- inserción de los registros en la tabla ejemplares
INSERT INTO ejemplares(id, idlibro, anyo, edicion, precio) VALUES
(1, 1, 1993, 5, 9.90),
(2, 1, 1993, 5, 19.90),
(3, 2, 1994, 2, 9.90),
(4, 2, 1994, 2, 9.90),
...
INSERT INTO socios(id, dni, nombre, apellidos, nacimiento, email, direccion, cp, poblacion, provincia, telefono, alta)
VALUES
(1, '25147854A', 'Marc', 'Soler','2000-01-10', 'marc@gmail.com', 'C. del Sol', '28080', 'Sabadell', 'Barcelona', '931 11 11', '2006-01-02 10:00:00'),
(2, '12385748B', 'Pol', 'Corts','1997-05-20', 'polcorts@hotmail.com', 'Pza. Major', '08205', 'Terrassa', 'Barcelona', '932 22 22', '2006-01-03 13:30:00'),
(3, '96685748C', 'David', 'Lloret','2002-09-11', 'lloret@mixmail.com', 'Ronda del Mig', '08204', 'Barcelona', 'Barcelona', '933 33 33', '2008-11-04 12:00:00'),
(4, '96857485D', 'Juan', 'Gisbert','2003-11-20', 'jgl@hotmail.com', 'C. La Rasa', '08201', 'Terrassa', 'Barcelona', '934 44 44', '2008-06-05 13:00:00'),
(5, '49499499E', 'Pere', 'Martí','1985-12-03', 'pmarti@gmail.com', 'Pza. Barcelona', '08205', 'Terrassa', 'Barcelona', '935 55 55', '2009-07-06 16:00:00'),
(6, '12484477F', 'Joan', 'Masdevila','1999-03-30', 'joan@hotmail.com', 'Pza. Tetuán', '08000', 'Barcelona', 'Barcelona', '936 66 66', '2010-12-06 17:30:00'),
(7, '96585478G', 'Ricart', 'Martorell','2000-11-16', 'joanot@gmail.com', 'Av. Diagonal', '08200', 'Barcelona', 'Barcelona', '937 77 77', '2014-05-17 10:15:00'),
(8, '96584755H', 'Francisco', 'Nicolás','1994-04-18', 'notalone@pop.es', 'Av. Madrid', '28080', 'Pozuelo de Alarcón', 'Madrid', '918 88 88', '2008-07-15 10:20:30'),
(9, '96587458S', 'Fernando', 'Martín','1954-05-09', 'femargo@aol.com', 'Pza. de la Dona', '08203', 'Terrassa', 'Barcelona', '939 99 99', '2001-02-27 10:15:00'),
(10, '85475847J', 'Marta', 'Márquez','1997-02-19', 'mm@hotmail.com', 'C. Montserrat', '08203', 'Terrassa', 'Barcelona', '930 00 00', '2011-12-26 09:50:00'),
(11,'65498732G','Fran','Cuesta','1978-01-15','fcuesta@yahoo.com','C. Sarajevo', '08203', 'Sabadell','Barcelona','666 66 67', '2011-12-27 09:15:00'),
(12,'12345874G','Marcelino','Cobos','1960-11-05','cobos@yahoo.com','Av. Estrasburg', '08205', 'Sabadell','Barcelona','665 48 75', '2010-10-12 10:15:00'),
(13,'12547854E','Elena','Salmerón','1958-10-01','salmeron@gmail.com','P. Recoletos', '28080', 'Madrid','Madrid','656 56 65', '2011-12-23 18:00:00'),
(14,'12578541S','Bartolomé','Cosido','1999-04-07','bartolo@hotmail.es','C. La Rasa', '08201', 'Terrassa','Barcelona','658 98 12', '2018-10-17 19:30:25'),
(15,'98574584R','Marcos','Pino','2000-09-30','marcospino@aol.com','C. Montjuïch', '08200', 'Barcelona','Barcelona','658 23 41', '2017-10-26 17:15:00'),
(16,'85474896A','Michelle','Rodriguez','2005-10-10','mich@gmail.com','Av. Pardo', '28080', 'Madrid','Madrid','918 33 55', '2018-10-15 18:00:00'),
(17,'85745874T','Juan','Ramos','1980-02-22','ramos@hotmail.es','C. La Rasa', '08201', 'Terrassa','Barcelona','938 83 41', '2014-10-13 10:15:00'),
(18,'15874587R', 'Eva', 'Gisbert','2000-01-01', 'egis@hotmail.com', 'C. La Rasa', '08201', 'Terrassa', 'Barcelona', '934 44 44', '2008-06-05 13:15:00'),
(19,'12387457R', 'Inés', 'Apropades','1983-11-21', 'aprop@gmail.com', 'C. Huesca', '50001', 'Zaragoza', 'Zaragoza', '745 85 48', '2011-01-04 14:00:00'),
(20,'12587474F', 'Magda', 'Montoro','1980-10-10', 'magda@hotmail.es', 'C. Molinos', '50300', 'Calatayud', 'Zaragoza', '625 25 14', '2011-06-15 18:00:00'),
(21,'02012012D', 'Armando', 'Guerra','1970-12-31', 'armando@aol.com', 'C. Ribalto', '50300', 'Calatayud', 'Zaragoza', '624 31 79', '2018-03-13 13:00:00');
...
(237, 10, 64, '2021-12-10 09:00:00', '2021-12-20', NULL),
(238, 2, 65, '2021-12-15 19:00:00', '2021-12-30', NULL),
(239, 1, 65, '2021-12-16 10:00:00', '2022-01-10', NULL),
(240, 4, 66, '2021-12-16 19:00:00', '2022-01-06', NULL);
